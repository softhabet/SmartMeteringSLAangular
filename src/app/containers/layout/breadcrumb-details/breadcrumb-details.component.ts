...
@Component({
  selector: 'app-breadcrumb-details',
  templateUrl: './breadcrumb-details.component.html'
})
export class BreadcrumbDetailsComponent {
  ...
  goToBack() {
    this.router.navigateByUrl('app/report-generation/reports');
  }
